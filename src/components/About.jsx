          ...
          <div className="relative mb-12">
            ...
            <div className="relative flex justify-between">
              {storyTimeline.map((story, index) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-full border-4 transition-all ${activeStory === index
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12">
              ...
              <p className="font-philosopher text-gray-600 leading-relaxed mb-6">
                At Avighnaa Trexim, we create powerful, results-driven brand strategies designed to help your business grow faster. Our approach goes beyond just planning — we continuously refine and optimize campaigns to deliver the best outcomes.
              </p>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <motion.div className="mt-8 flex flex-wrap justify-center gap-2">
              {countries.map((country, i) => (
                <motion.button
                  key={country.name}
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${hoveredCountry?.name === country.name
